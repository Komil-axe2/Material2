    ...
    <>
      <Layout >
        <Container sx={{ maxWidth: "1200px", margin: "auto", marginLeft: "12%" }} >
            ...
            {Array.from(Array(12)).map((_, index) => (
              <Grid item xs={5} sm={4} md={3} key={index}>
                <Box width={220} height={330} boxShadow={3} bgcolor={"#fff"} borderRadius={"20px"}>
                  ...
                  <p style={{ padding: "5%" }}>Lorem ipsum dolor sit amet consectetur.</p>
          ...
          <button style={{ marginLeft: "23%", width: "50%", height: "4vh", marginBottom: "3%" }}>Yana Ko'rsatish 20</button>
        </Container>
      </Layout>
    </>
  );
